...
import com.uniguard.ptt_app.drawable.CircleDrawable;
...
public class ChannelListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
        implements UserMenu.IUserLocalStateListener {
    ...
    /**
     * Recursively creates a list of {@link Node}s representing the channel
     * hierarchy.
     * 
