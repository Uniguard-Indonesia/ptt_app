...
public abstract class AbstractCommentFragment extends DialogFragment {
        ...
        mTabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                if ("View".equals(tabId)) {
                    ...
                    // Load edittext content for the first time when the tab is selected, to improve
    ...
    /**
     * Requests a comment from the service. Will not be called if we already have a
     * comment provided.
     * This method is expected to set a callback that will call
     * {@link com.uniguard.ptt_app.channel.comment.AbstractCommentFragment#loadComment(String comment)}.
     * 
