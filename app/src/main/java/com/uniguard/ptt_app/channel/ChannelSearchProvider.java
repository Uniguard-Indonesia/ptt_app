...
public class ChannelSearchProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        for (int x = 0; x < channels.size(); x++) {
            ...
            cursor.addRow(
                    new Object[] { x, INTENT_DATA_CHANNEL, channel.getName(), R.drawable.ic_action_channels,
                            getContext().getResources().getQuantityString(R.plurals.search_channel_users,
                                    channel.getSubchannelUserCount(), channel.getSubchannelUserCount()),
                            channel.getId() });
        }
    ...
    /**
     * Recursively searches the channel tree for a user with a name containing the
     * given string,
     * ignoring case.
     * 
    ...
    /**
     * Recursively searches the channel tree for a channel with a name containing
     * the given string,
     * ignoring case.
     * 
