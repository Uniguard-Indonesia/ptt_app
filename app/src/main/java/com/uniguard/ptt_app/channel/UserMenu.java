...
import com.uniguard.ptt_app.channel.comment.UserCommentFragment;
import com.uniguard.ptt_app.service.MumlaService;
import com.uniguard.ptt_app.util.ModelUtils;
...
public class UserMenu implements PermissionsPopupMenu.IOnMenuPrepareListener, PopupMenu.OnMenuItemClickListener {
    ...
    public void onMenuPrepare(Menu menu, int permissions) {
        ...
        // TODO info
        // informationItem.enabled = (((perms & (Permissions.Write |
        // Permissions.Register))) > 0 || (channelPermissions & (Permissions.Write |
        // Permissions.Enter)) > 0 || (mUser.getSessionId() ==
        // mService.getSessionId()));
    ...
    private void showUserComment(final boolean edit) {
        ...
        UserCommentFragment fragment = (UserCommentFragment) Fragment.instantiate(mContext,
                UserCommentFragment.class.getName(), args);
