...
/**
 * Fragment class intended to make binding the Humla service to fragments
 * easier.
...
public abstract class HumlaServiceFragment extends Fragment {
    ...
    /**
     * State boolean to make sure we don't double initialize a fragment once a
    ...
    /**
     * The definitive place where data from the service will be used to initialize
     * the fragment. Only called once per bind, whether the fragment loads first or
     * the service.
     */
    ...
    /**
     * If implemented, will register the returned observer to the service upon
     * binding.
     */
