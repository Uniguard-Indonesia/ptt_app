...
/**
 * A wrapper around a {@link android.view.MenuInflater} that tints menu items to
 * the control color
...
public class TintedMenuInflater {
    ...
    public TintedMenuInflater(Context context, MenuInflater inflater) {
        ...
        TypedArray titleTextStyleArray = context.obtainStyledAttributes(actionBarTheme,
                new int[] { R.attr.titleTextStyle });
        int titleTextStyle = titleTextStyleArray.getResourceId(0, 0);
        titleTextStyleArray.recycle();

        TypedArray textColorArray = context.obtainStyledAttributes(titleTextStyle,
