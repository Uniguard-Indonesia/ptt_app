...
public class MumbleImageGetter implements Html.ImageGetter {
    ...
    public Drawable getDrawable(String source) {
        ...
        DisplayMetrics metrics = mContext.getResources().getDisplayMetrics(); // Use display metrics to scale image to
                                                                              // mdpi
        drawable.setBounds(0, 0, (int) ((float) drawable.getIntrinsicWidth() * metrics.density),
                (int) ((float) drawable.getIntrinsicHeight() * metrics.density));
