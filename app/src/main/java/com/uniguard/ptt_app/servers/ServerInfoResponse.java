...
public class ServerInfoResponse {
    ...
    /**
     * Whether or not this server info response represents a failure to retrieve a
     * response. Used to efficiently denote failed responses.
     */
    ...
    /**
     * Instantiating a ServerInfoResponse with no data will cause it to be
     * considered a 'dummy' response by its handler.
     */
