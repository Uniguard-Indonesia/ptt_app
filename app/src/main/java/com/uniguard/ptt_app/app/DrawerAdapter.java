...
public class DrawerAdapter extends ArrayAdapter<DrawerAdapter.DrawerRow> {
    ...
    public DrawerAdapter(Context context, DrawerDataProvider provider) {
        ...
        add(new DrawerAdapter.DrawerItem(ITEM_SERVER, context.getString(R.string.drawer_server),
                R.drawable.ic_action_channels));
        // add(new DrawerAdapter.DrawerItem(ITEM_PINNED_CHANNELS,
        // context.getString(R.string.drawer_pinned), R.drawable.ic_action_comment));
        add(new DrawerAdapter.DrawerItem(ITEM_INFO, context.getString(R.string.information),
                R.drawable.ic_action_info_dark));
        // add(new DrawerAdapter.DrawerItem(ITEM_ACCESS_TOKENS,
        // context.getString(R.string.drawer_tokens), R.drawable.ic_action_save));
        add(new DrawerAdapter.DrawerHeader(HEADER_SERVERS, context.getString(R.string.drawer_header_servers)));
        add(new DrawerAdapter.DrawerItem(ITEM_FAVOURITES, context.getString(R.string.drawer_favorites),
                R.drawable.ic_action_favourite_on));
        // add(new DrawerAdapter.DrawerItem(ITEM_LAN,
        // context.getString(R.string.drawer_lan), R.drawable.ic_action_fullscreen)); //
        // Coming soon, TODO
        // add(new DrawerAdapter.DrawerItem(ITEM_PUBLIC,
        // context.getString(R.string.drawer_public), R.drawable.ic_action_search));
        add(new DrawerAdapter.DrawerHeader(HEADER_GENERAL, context.getString(R.string.general)));
        add(new DrawerAdapter.DrawerItem(ITEM_SETTINGS, context.getString(R.string.action_settings),
                R.drawable.ic_action_settings));
        add(new DrawerAdapter.DrawerItem(ITEM_LOGOUT, context.getString(R.string.logout_yes),
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (viewType == HEADER_TYPE) {
            ...
            textColor |= enabled ? 0xFF000000 : 0x55000000; // Set alpha bits depending on whether the state is enabled
            // or disabled
