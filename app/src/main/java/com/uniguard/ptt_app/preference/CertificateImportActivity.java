...
public class CertificateImportActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        String displayName;
        Cursor cursor = getContentResolver().query(uri, new String[] { OpenableColumns.DISPLAY_NAME }, null, null,
                null);
    ...
    private void storeKeystore(final char[] password, final String fileName, final InputStream input) {
        ...
        try {
            ...
            // A problem occurred when reading the stream; interpret this as a password
            // being
            // required. Request a password from the user and reattempt decryption.
            // FIXME(acomminos): examine p12 file's SafeBags to determine the presence of a
            // password
