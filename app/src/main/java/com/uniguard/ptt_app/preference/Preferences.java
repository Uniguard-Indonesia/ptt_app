...
public class Preferences extends PreferenceActivity {
    ...
    public static final String ACTION_PREFS_GENERAL = "com.uniguard.ptt.app.PREFS_GENERAL";
    public static final String ACTION_PREFS_AUTHENTICATION = "com.uniguard.ptt.app.PREFS_AUTHENTICATION";
    public static final String ACTION_PREFS_AUDIO = "com.uniguard.ptt.app.PREFS_AUDIO";
    public static final String ACTION_PREFS_APPEARANCE = "com.uniguard.ptt.app.PREFS_APPEARANCE";
    public static final String ACTION_PREFS_ABOUT = "com.uniguard.ptt.app.PREFS_ABOUT";
    ...
    private static void configureAudioPreferences(final PreferenceScreen screen) {
        ...
        for (int x = 0; x < bitrateNames.length; x++) {
            ...
            boolean supported = AudioRecord.getMinBufferSize(bitrate, AudioFormat.CHANNEL_IN_MONO,
