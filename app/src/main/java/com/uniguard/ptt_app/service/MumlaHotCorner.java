...
/**
 * A hot corner in an area of the screen specified by
 * {@link MumlaHotCorner#getGravity()}.
...
public class MumlaHotCorner implements View.OnTouchListener {
    ...
    /**
     * Updates the hot corner with any new settings applied, recalculating the
     * layout parameters.
