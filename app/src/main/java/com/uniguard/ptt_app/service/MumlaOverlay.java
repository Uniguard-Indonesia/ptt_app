...
import com.uniguard.ptt_app.channel.ChannelAdapter;
...
public class MumlaOverlay {
    ...
    public MumlaOverlay(MumlaService service) {
        ...
        // mToggleButton = (ImageView)
        // mOverlayView.findViewById(R.id.overlay_mode_toggle);
        ...
        mTitleView.setOnTouchListener(new View.OnTouchListener() {
            private final WindowManager mWindowManager = (WindowManager) mService
